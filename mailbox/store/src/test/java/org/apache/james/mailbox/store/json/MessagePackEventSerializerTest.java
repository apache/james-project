...
public class MessagePackEventSerializerTest {
    ...
    private MessagePackEventSerializer<TestId> messagePackEventSerializer;
    ...
    public void setUp() {
        ...
        messagePackEventSerializer = new MessagePackEventSerializer<TestId>(new MailboxConverter<TestId>(new TestIdDeserializer()));
    ...
    public void addedEventShouldBeWellConverted() throws Exception {
        ...
        byte[] serializedEvent = messagePackEventSerializer.serializeEvent(event);
        MailboxListener.Event deserializedEvent = messagePackEventSerializer.deSerializeEvent(serializedEvent);
