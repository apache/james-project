...
public class InMemoryMailboxManagerTest extends AbstractMailboxManagerTest {
    ...
    public InMemoryMailboxManagerTest() throws Exception {
        mailboxSessionMapperFactory = new InMemoryMailboxSessionMapperFactory();
        mailboxManager = new InMemoryMailboxManager(mailboxSessionMapperFactory, null, new JVMMailboxPathLocker(), new UnionMailboxACLResolver(), null);
        mailboxManager.init();
    }
