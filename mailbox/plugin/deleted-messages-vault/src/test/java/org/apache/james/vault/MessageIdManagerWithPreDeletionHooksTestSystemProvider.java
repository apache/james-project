...
public class MessageIdManagerWithPreDeletionHooksTestSystemProvider {
    ...
    public static CombinationManagerTestSystem createTestingData(SessionProvider sessionProvider,
        ...
        InMemoryMailboxManager mailboxManager = inMemoryIntegrationResources
            .createResourcesForHooks(sessionProvider, memoryMailboxSessionMapperFactory, preDeletionHooks).getMailboxManager();
