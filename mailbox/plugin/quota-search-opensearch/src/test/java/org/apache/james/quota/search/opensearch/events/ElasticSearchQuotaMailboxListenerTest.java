...
class ElasticSearchQuotaMailboxListenerTest {
    ...
    org.apache.james.quota.search.elasticsearch.v8.events.ElasticSearchQuotaMailboxListener quotaMailboxListener;
    ...
    void setUp() throws IOException {
        ...
        quotaMailboxListener = new org.apache.james.quota.search.elasticsearch.v8.events.ElasticSearchQuotaMailboxListener(
    ...
    void deserializeElasticSearchQuotaMailboxListenerGroup() throws Exception {
        assertThat(Group.deserialize("org.apache.james.quota.search.elasticsearch.v8.events.ElasticSearchQuotaMailboxListener$ElasticSearchQuotaMailboxListenerGroup"))
        ...
        CALMLY_AWAIT.atMost(Durations.TEN_SECONDS)
            .untilAsserted(() -> assertThat(client.search(
                new SearchRequest.Builder()
                    .index(QuotaRatioElasticSearchConstants.DEFAULT_QUOTA_RATIO_READ_ALIAS.getValue())
