...
public class PostgresMailboxDAOImplTest extends PostgresMailboxDAOTest {
    @RegisterExtension
    static PostgresExtension postgresExtension = new PostgresExtension(PostgresMailboxModule.MODULE);

    @Override
    PostgresMailboxDAO postgresMailboxDAO() {
        return new PostgresMailboxDAOImpl(postgresExtension.getPostgresExecutor());
    }
}
