...
public interface CassandraMailboxRecentsDataDefinition {
    CassandraDataDefinition MODULE = CassandraDataDefinition.table(CassandraMailboxRecentsTable.TABLE_NAME)
