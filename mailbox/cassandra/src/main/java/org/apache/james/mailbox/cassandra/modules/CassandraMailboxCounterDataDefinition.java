...
public interface CassandraMailboxCounterDataDefinition {
    CassandraDataDefinition MODULE = CassandraDataDefinition.table(CassandraMailboxCountersTable.TABLE_NAME)
