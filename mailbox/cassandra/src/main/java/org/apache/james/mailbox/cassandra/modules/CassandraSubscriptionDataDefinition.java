...
public interface CassandraSubscriptionDataDefinition {

    int PER_USER_CACHED_SUBSCRIPTIONS = 100;

    CassandraDataDefinition MODULE = CassandraDataDefinition.table(CassandraSubscriptionTable.TABLE_NAME)
