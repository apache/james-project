...
public interface CassandraApplicableFlagsDataDefinition {
    CassandraDataDefinition MODULE = CassandraDataDefinition.table(CassandraApplicableFlagTable.TABLE_NAME)
