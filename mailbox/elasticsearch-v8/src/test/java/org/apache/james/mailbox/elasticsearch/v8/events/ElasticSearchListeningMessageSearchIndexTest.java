...
import org.apache.james.mailbox.elasticsearch.v8.IndexAttachments;
import org.apache.james.mailbox.elasticsearch.v8.MailboxElasticSearchConstants;
import org.apache.james.mailbox.elasticsearch.v8.MailboxIdRoutingKeyFactory;
...
class ElasticSearchListeningMessageSearchIndexTest {
    ...
    void deserializeElasticSearchListeningMessageSearchIndexGroup() throws Exception {
        assertThat(Group.deserialize("org.apache.james.mailbox.elasticsearch.v8.events.ElasticSearchListeningMessageSearchIndex$ElasticSearchListeningMessageSearchIndexGroup"))
    ...
    void addShouldIndexMultipleMessages() throws Exception {
        ...
        awaitForElasticSearch(QueryBuilders.matchAll().build()._toQuery(), 2L);
    ...
    void deleteShouldRemoveIndex() throws Exception {
        ...
        awaitForElasticSearch(QueryBuilders.matchAll().build()._toQuery(), 0L);
        ...
        CALMLY_AWAIT.atMost(Durations.TEN_SECONDS)
                .untilAsserted(() -> assertThat(client.search(
                        new SearchRequest.Builder()
                            .index(MailboxElasticSearchConstants.DEFAULT_MAILBOX_INDEX.getValue())
                            .query(query)
                            .build())
                        .block()
