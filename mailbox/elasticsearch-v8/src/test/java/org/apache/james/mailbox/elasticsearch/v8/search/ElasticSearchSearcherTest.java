...
package org.apache.james.mailbox.elasticsearch.v8.search;
...
import org.apache.james.mailbox.elasticsearch.v8.events.ElasticSearchListeningMessageSearchIndex;
...
class ElasticSearchSearcherTest {
    ...
    void searchingInALargeNumberOfMailboxesShouldReturnAllMailboxesMessagesUid() throws Exception {
        ...
        awaitForElasticSearch(QueryBuilders.matchAll().build()._toQuery(), composedMessageIds.size());
