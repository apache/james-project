...
# Repel brute force attackes with Linux firewall (iptables) and fail2ban
...
Ubuntu installs the software. After start fail3ban manually. Finally the service is set to start
