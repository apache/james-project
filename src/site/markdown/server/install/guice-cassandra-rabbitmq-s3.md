...
### Requirements
 ...
 - Java 11 SDK
 - Docker ∕ OpenSearch 2.1.0, RabbitMQ Management 3.8.18, compatible S3 ObjectStorage and Cassandra 5.0.9
 - Maven 3
...
```bash
$ docker run -d -p 9042:9042 --name=cassandra cassandra:5.0.9
