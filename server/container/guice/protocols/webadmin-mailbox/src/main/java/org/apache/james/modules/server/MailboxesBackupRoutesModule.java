...
public class MailboxesBackupRoutesModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        Multibinder<TaskFromRequestRegistry.TaskRegistration> taskRegistrations = Multibinder.newSetBinder(binder(), TaskFromRequestRegistry.TaskRegistration.class, Names.named(UserMailboxesRoutes.USER_MAILBOXES_OPERATIONS_INJECTION_KEY));
