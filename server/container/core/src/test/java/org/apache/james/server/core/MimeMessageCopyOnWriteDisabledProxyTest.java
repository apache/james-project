...
public class MimeMessageCopyOnWriteDisabledProxyTest extends MimeMessageFromStreamTest {
    ...
    static void setUp() {
        ...
        System.setProperty(MimeMessageCopyOnWriteProxy.DISABLE_COPY_ON_WRITE, "disabled");
    }
    @AfterAll
    static void tearDown() {
        System.clearProperty(MimeMessageCopyOnWriteProxy.DISABLE_COPY_ON_WRITE);
    }
...
//        assertThat(isSameMimeMessage(m2clone.getMessage(), mm)).isTrue();
     ...
     */
    @Test
    @Disabled("When copy on write is disabled cloning always occurs")
