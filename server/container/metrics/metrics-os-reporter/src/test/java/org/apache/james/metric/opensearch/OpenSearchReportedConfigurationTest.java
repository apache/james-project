...
class OpenSearchReportedConfigurationTest {

    @Test
    void builderShouldThrowWhenNotToldIfEnabled() {
        assertThatThrownBy(() -> OpenSearchReporterConfiguration.builder().build())
            .isInstanceOf(IllegalStateException.class);
    }

    @Test
    void builderShouldThrowIfEnabledWithoutHostAndPort() {
        assertThatThrownBy(() -> OpenSearchReporterConfiguration.builder()
                .enabled()
                .build())
            .isInstanceOf(IllegalStateException.class);
    }
    ...
    void builderShouldWorkWhenDisabled() {
        OpenSearchReporterConfiguration configuration = OpenSearchReporterConfiguration.builder()
            .disabled()
            .build();

        assertThat(configuration.isEnabled()).isFalse();
        assertThat(configuration.getIndex()).isEqualTo(OpenSearchReporterConfiguration.DEFAULT_INDEX);
        assertThat(configuration.getPeriodInSecond()).isEqualTo(OpenSearchReporterConfiguration.DEFAULT_PERIOD_IN_SECOND);
    }
