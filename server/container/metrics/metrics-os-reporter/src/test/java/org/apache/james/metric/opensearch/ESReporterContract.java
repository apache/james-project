...
abstract class ESReporterContract {
    ...
    private OpenSearchMetricReporter openSearchMetricReporter;
    ...
    void setUp(DockerElasticSearch elasticSearch) {
        ...
        timer = new Timer();
        openSearchMetricReporter = new OpenSearchMetricReporter(
            OpenSearchReporterConfiguration.builder()
                .enabled()
        ...
        openSearchMetricReporter.start();
    }

    @AfterEach
    void tearDown() {
        timer.cancel();
        openSearchMetricReporter.stop();
    }
