...
public class OpenSearchReporterConfiguration {
    ...
    public static class Builder {
        ...
        public OpenSearchReporterConfiguration build() {
            ...
            return new OpenSearchReporterConfiguration(host, port, enabled.get(), index, periodInSecond);
        }
    }
    ...
    public OpenSearchReporterConfiguration(Optional<String> host, Optional<Integer> port, boolean enabled, Optional<String> index, Optional<Long> periodInSecond) {
        this.host = host;
        this.port = port;
