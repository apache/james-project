...
public class QuotaClient {
    ...
    public Long getQuotaCount() {
        return feignClient.getQuotaCount();
    }

    public Long getQuotaSize() {
        return feignClient.getQuotaSize();
    }

    public void setQuotaCount(Long count) {
        try (Response response = feignClient.setQuotaCount(count)) {
    ...
    public void setQuotaSize(Long size) {
        try (Response response = feignClient.setQuotaSize(size)) {
    ...
    public void deleteQuotaCount() {
        try (Response response = feignClient.deleteQuotaCount()) {
    ...
    public void deleteQuotaSize() {
        try (Response response = feignClient.deleteQuotaSize()) {
