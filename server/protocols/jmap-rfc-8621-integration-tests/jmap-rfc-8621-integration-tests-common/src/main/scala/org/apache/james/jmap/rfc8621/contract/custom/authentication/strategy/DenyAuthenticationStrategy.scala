...
case class DenyAuthenticationStrategy() extends AuthenticationStrategy {
  ...
  override def correspondingChallenge(): AuthenticationChallenge =
    AuthenticationChallenge.of(AuthenticationScheme.of("Deny Authentication Strategy"), ImmutableMap.of)
}
