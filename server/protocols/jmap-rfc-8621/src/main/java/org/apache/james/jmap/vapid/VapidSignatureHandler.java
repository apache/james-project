...
public class VapidSignatureHandler implements SignatureHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(VapidSignatureHandler.class);
    ...
    @Inject
    @VisibleForTesting
    VapidSignatureHandler(SecurityKeyLoader keyLoader) {
        this.keyLoader = keyLoader;
    }

    @Override
    public void create() throws Exception {
        securityKeys = keyLoader.loadAsymmetricKeys();
    }
    ...
    public String getPublicKeyAsString() {
        return IOUtils.toString(securityKeys.getPublicKey().getEncoded(), "US_ASCII");
    }
}
