...
public class DefaultWebPushClientServerSideForgeryTest implements SafeWebPushClientContract {
    @RegisterExtension
    ...
    @BeforeEach
    void beforeEach() {
        defaultWebPushClient = new DefaultWebPushClient(SafeWebPushClientTestFixture.PUSH_CLIENT_CONFIGURATION());
