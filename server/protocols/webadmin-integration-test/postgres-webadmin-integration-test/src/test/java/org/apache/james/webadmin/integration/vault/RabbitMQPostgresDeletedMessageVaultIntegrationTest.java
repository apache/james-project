...
class RabbitMQPostgresDeletedMessageVaultIntegrationTest {
    @RegisterExtension
    ...
    void restoreDeletedMessageShouldSucceed(GuiceJamesServer jamesServer) throws Exception {
        ...
        assertThat(testIMAPClient.select(DefaultMailboxes.RESTORED_MESSAGES)
            .awaitMessageCount(AWAIT, 1)
            .readFirstMessage())
            .contains("Subject: thisIsASubject\r\n\r\nBody");
    }
