...
public class OidcJwtTokenVerifier {
    ...
    public Optional<String> verifyAndExtractClaim(String jwtToken, URL jwksURL, String claimName) {
        PublicKeyProvider jwksPublicKeyProvider = JwtTokenHelper.getClaimWithoutSignatureVerification(jwtToken, "kid", String.class)
            .map(kidValue -> OidcJwksPublicKeyProvider.of(jwksURL, kidValue))
            .orElse(OidcJwksPublicKeyProvider.of(jwksURL));
