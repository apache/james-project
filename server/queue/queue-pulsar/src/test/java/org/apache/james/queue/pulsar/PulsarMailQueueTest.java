...
public class PulsarMailQueueTest implements MailQueueContract, MailQueueMetricContract, ManageableMailQueueContract, DelayedMailQueueContract, DelayedManageableMailQueueContract {
    ...
    // https://ci-builds.apache.org/job/james/job/ApacheJames/job/PR-1200/4/testReport/junit/org.apache.james.queue.pulsar/PulsarMailQueueTest/removeByNameShouldRemoveSpecificEmail/
    @Disabled
    @Test
    public void removeByNameShouldRemoveSpecificEmail() throws Exception {
        DelayedManageableMailQueueContract.super.removeByNameShouldRemoveSpecificEmail();
    }
