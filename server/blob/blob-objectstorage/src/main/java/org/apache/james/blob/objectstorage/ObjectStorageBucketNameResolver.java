...
class ObjectStorageBucketNameResolver {
    ...
    private ObjectStorageBucketNameResolver(Optional<BucketName> namespace, Optional<String> prefix) {
    ...
    ObjectStorageBucketName resolve(BucketName bucketName) {
        ...
        return prefix
            .map(bucketPrefix -> ObjectStorageBucketName.of(bucketPrefix + bucketName.asString()))
