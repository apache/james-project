...
public class GCBlobCompactionTask implements Task {
    public static final TaskType TASK_TYPE = TaskType.of("GCBlobCompactionTask");
    private static final Logger LOGGER = LoggerFactory.getLogger(GCBlobCompactionTask.class);
    ...
    public static class AdditionalInformation implements TaskExecutionDetails.AdditionalInformation {
        ...
        @Override
        public int hashCode() {
            return Objects.hash(timestamp, bucketName, generation, family, deadPurged, mergedChunks, freedBytes);
        }
    ...
    public GCBlobCompactionTask(BlobCompactionAlgorithm algorithm, CompactionRequest request, Clock clock) {
    ...
    public Result run() {
        try {
            ...
            LOGGER.error("Error while running GCBlobCompactionTask for generation {}", request.generation(), e);
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof GCBlobCompactionTask that) {
