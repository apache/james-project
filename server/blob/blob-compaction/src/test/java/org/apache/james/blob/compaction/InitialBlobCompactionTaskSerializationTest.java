...
class InitialBlobCompactionTaskSerializationTest {
    ...
    void shouldMatchJsonSerializationContract() throws Exception {
        ...
        InitialBlobCompactionTask task = new InitialBlobCompactionTask(algorithm, request, clock);

        JsonSerializationVerifier.dtoModule(BlobCompactionDTOModules.initialCompactionTaskModule(algorithm, clock))
            .bean(task)
            .json(ClassLoaderUtils.getSystemResourceAsString("json/initialBlobCompaction.task.json"))
            .verify();
    }
}
