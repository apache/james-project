...
class BlobCompactionTaskSerializationTest {
    ...
    void shouldMatchJsonSerializationContract() throws Exception {
        ...
        JsonSerializationVerifier.dtoModule(BlobCompactionDTOModules.taskModule(algorithm, clock))
            .bean(task)
            .json(ClassLoaderUtils.getSystemResourceAsString("json/blobCompaction.task.json"))
            .verify();
    }
}
