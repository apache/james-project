...
public class S3BlobStoreDAOWithSSECKeyDerivationTest implements BlobStoreDAOContract, S3SSECContract {
    ...
    static void setUp() {
        ...
        S3SSECustomerKeyFactory sseCustomerKeyFactory = new S3SSECustomerKeyFactory.DerivedCustomerKeyFactory(new S3SSECConfiguration.KeyDerivationEnabled("AES256"));
