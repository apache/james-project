...
class RecipientHasMXRecordTest {
    ...
    void matchShouldFilterRecipients() throws Exception {
        ...
        Collection<MailAddress> result = testee.match(FakeMail.builder()
            .name("anything")
            .sender("semder@other.com")
            .recipient("recipient1@domain1.com")
            .recipient("recipient2@domain2.com")
            .build());

        assertThat(result).containsOnly(new MailAddress("recipient1@domain1.com"));
    }
}
