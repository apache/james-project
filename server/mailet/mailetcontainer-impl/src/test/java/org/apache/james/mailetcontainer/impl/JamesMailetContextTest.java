...
public class JamesMailetContextTest {
    ...
    private static final Username USERMAIL_ANY_COM = Username.of(USERNAME + "@any.com");
    ...
    class Config {
        ...
        void setUp() throws Exception {
            ...
            DomainListConfiguration configuration = DomainListConfiguration.builder()
                ...
                .build();
            domainList = spy(new MemoryDomainList(configuration));
            domainList.addDomain(domainList.getDefaultDomain());
        ...
        void isLocalUserShouldReturnTrueWhenUsedWithLocalPartAndUserExistOnDefaultDomain() throws Exception {
            usersRepository.addUser(USERMAIL_ANY_COM, PASSWORD);
