...
public interface CassandraNotificationRegistryDataDefinition {
    CassandraDataDefinition MODULE = CassandraDataDefinition.table(CassandraNotificationTable.TABLE_NAME)
