...
public interface CassandraVacationDataDefinition {
    CassandraDataDefinition MODULE = CassandraDataDefinition.table(CassandraVacationTable.TABLE_NAME)
        ...
        .statement(statement -> types -> statement
            ...
            .withColumn(CassandraVacationTable.FROM_DATE, types.getDefinedUserType(CassandraZonedDateTimeDataDefinition.ZONED_DATE_TIME))
            .withColumn(CassandraVacationTable.TO_DATE, types.getDefinedUserType(CassandraZonedDateTimeDataDefinition.ZONED_DATE_TIME))
