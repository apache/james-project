...
public class WithZstdBlobStoreTest {
    ...
    private static final String COMPRESSIBLE_PAYLOAD = "James zstd blob store integration payload.\n".repeat(2048);
    ...
    @Test
    void blobStoreShouldPersistCompressedBlobsWithZstdMetadata(GuiceJamesServer server) {
