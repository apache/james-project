...
| email.change.ttl
| Optional. Duration, default to 60 days. Cassandra Time-to-live for Email change records.

| mailbox.change.ttl
| Optional. Duration, default to 60 days. Cassandra Time-to-live for Mailbox change records.
