...
We introduced xref:operate/james-benchmark.adoc[tools and standard benchmark result for Distributed James] also xref:operate/db-benchmark.adoc[James database's base performance and how to benchmark them].
