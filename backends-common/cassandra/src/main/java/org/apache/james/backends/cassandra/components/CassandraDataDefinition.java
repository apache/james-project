...
public interface CassandraDataDefinition {

    class Impl implements CassandraDataDefinition {
    ...
    class Builder {
        ...
        public Builder module(CassandraDataDefinition module) {
            return modules(ImmutableList.of(module));
        }

        public Builder modules(Collection<CassandraDataDefinition> modules) {
        ...
        public Builder modules(CassandraDataDefinition... modules) {
    ...
    static CassandraDataDefinition aggregateModules(CassandraDataDefinition... modules) {
        return aggregateModules(Arrays.asList(modules));
    }

    static CassandraDataDefinition aggregateModules(Collection<CassandraDataDefinition> modules) {
        return builder()
            .modules(modules)
            .build();
    }

    CassandraDataDefinition EMPTY_MODULE = builder().build();
