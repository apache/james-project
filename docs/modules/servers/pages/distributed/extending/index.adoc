...
Writing xref:distributed/extending/imap.adoc[IMAP extensions].
...
It is shipped with two backends implemented:
 ...
 - Alternative extensions can be written and loaded into James using the xref:distributed/extending/index.adoc#_handling_injections_for_your_extensions[Guice extension mechanism]
