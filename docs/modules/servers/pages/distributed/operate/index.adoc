...
.Upgrade path
|===
| Upgrade from | Recommended upgrade path to {james-version}

| 3.9.0
| Upgrade, and apply link:https://github.com/apache/james-project/blob/master/upgrade-instructions.md#391-version[3.9.1 upgrade instructions]

| 3.8.0 - 3.8.2
| 1. Upgrade, and apply link:https://github.com/apache/james-project/blob/master/upgrade-instructions.md#390-version[3.9.0 upgrade instructions]

2. Upgrade, and apply link:https://github.com/apache/james-project/blob/master/upgrade-instructions.md#391-version[3.9.1 upgrade instructions]
