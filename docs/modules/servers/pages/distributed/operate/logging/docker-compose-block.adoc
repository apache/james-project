[source,docker-compose,subs=attributes+]
----
version: "3"
...
services:
  ...
  cassandra:
    image: cassandra:{cassandra-version}
    ports:
      - "9042:9042"
  ...
  s3:
    image: ghcr.io/scality/cloudserver:{cloudserver-version}
  ...
  fluent-bit:
    image: fluent/fluent-bit:{fluent-bit-version}
    volumes:
  ...
  opensearch-dashboards:
    image: opensearchproject/opensearch-dashboards:{opensearch-version}
    environment:
