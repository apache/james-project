...
[subs=attributes+]
----
docker pull apache/james:distributed-{james-version}
----
...
[subs=attributes+]
----
$ docker run -d --network james --name=cassandra cassandra:{cassandra-version}
----
...
$ docker run --network james --hostname HOSTNAME -p "25:25" -p 80:80 -p "110:110" -p "143:143" -p "465:465" -p "587:587" -p "993:993" -p "127.0.0.1:8000:8000" --name james_run
    -v $PWD/keystore:/root/conf/keystore -t apache/james:distributed-{james-version} --generate-keystore
----
