...
| Optional. Optional. Configure the duration of the interval between consecutive "ping" messages sent by the server to the client over a WebSocket connection.
