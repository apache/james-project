...
ifndef::no-jmap[]
image::customization/james-hexagons-extensions.png[Extension mechanisms for the James Server]
endif::[]
ifdef::no-jmap[]
image::customization/james-hexagons-extensions-jpa.png[Extension mechanisms for the James Server]
endif::[]
...
Writing xref:{pages-path}/customization/mailbox-listeners.adoc[Mailbox listeners] enables to
...
Writing xref:{pages-path}/customization/webadmin-routes.adoc[WebAdmin routes] enables to
...
* 4. *MyServiceModule* needs to be registered in xref:servers:distributed/configure/extensions.adoc[*extensions.properties*]
