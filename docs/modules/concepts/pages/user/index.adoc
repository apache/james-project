 ...
 * A xref:servers:distributed/index.adoc[Distributed Server] well-suited for Operators with
...
develop extensions  to customize the behavior of a xref:servers:index.adoc[James server].
