 ...
 * An xref:servers:extendable/index.adoc[Advanced Server] well-suited for Operators with
...
develop xref:customization:index.adoc[Extensions] to customize the behavior of a James server.
