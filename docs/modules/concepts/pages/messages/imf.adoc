...
forwarding of messages. The body content is dealt with in xref:concepts:messages/mime.adoc#_rfc2045[RFC2045]
...
split into a separate specification, xref:concepts:protocols/smtp.adoc#_rfc2821[RFC2821].
